...
/**
 * A testing class for the ShowManager classes
 * @author Gus Teran
 *
 */
...
//	ShowManager2 sm1 = new ShowManager2();
	...
	public ShowExamples()
	{
		...
		Show s5 = new Show("TestShow5", 600, eps4, false);	shows2.add(s5);	report2.daytime.add(s5);
		Show s6 = new Show("TestShow6", 599, eps4, false);	shows2.add(s6);
		Show s7 = new Show("TestShow7", 100, eps4, false);	shows2.add(s7);
		Show s8 = new Show("TestShow8", 0, eps4, false);	shows2.add(s8);	report2.latenight.add(s8);
		Show s9 = new Show("TestShow9", 2200, eps4, false);	shows2.add(s9);	report2.latenight.add(s9);
		Show s10 = new Show("TestShow9", 1700, eps4, false);	shows2.add(s10);	report2.primetime.add(s10);
	}
	...
	@Test
	public void empty() {
		assertEquals(new ShowSummary(), sm1.organizeShows(new LinkedList<Show>()));
	}
